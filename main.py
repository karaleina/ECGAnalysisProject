...
list_of_isoelectrics_chann0 = analyzerRR.get_list_of_intervals_isoelectric_line(list_of_intervals_chann0, margin_to_discard=0.3)
list_of_isoelectrics_chann1 = analyzerRR.get_list_of_intervals_isoelectric_line(list_of_intervals_chann1, margin_to_discard=0.3)
