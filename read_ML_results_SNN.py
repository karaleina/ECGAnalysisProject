from Step4_processing_data_and_wizualization import read_with_pickle, calculate_ROC_curve, transform_dataset_into_wavelets_coeffs_dataset
...
nn = read_with_pickle(os.path.join(os.getcwd(), "results_ML", "nn" + str(8)) + ".pkl")
dataset_type = "wavelets"
